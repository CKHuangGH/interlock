...
ssh -o StrictHostKeyChecking=no root@$j chmod 777 -R /root/interclock/
i=$((i+1))
done

scp cp_node_list root@$manage:/root/interclock/package/cp_node_list
scp all_node_list root@$manage:/root/interclock/package/all_node_list
